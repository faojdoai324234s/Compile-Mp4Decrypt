#ifndef _MP4DECRYPT_H
#define _MP4DECRYPT_H

#include <atomic>
#include <cstdint>
#include <string>

// A class for decrypting CENC-encrypted data. The decryption operation is hardware-accelerated by using AES-NI.
class Mp4Decrypt final {
	
public:
	Mp4Decrypt(const Mp4Decrypt& other) = delete;
	Mp4Decrypt& operator=(const Mp4Decrypt& other) = delete;
	Mp4Decrypt(Mp4Decrypt&& other) = delete;
